...
# kopia reads the repository password from the environment; the server password is
# passed on the command line. Both come from podman secrets, never from the unit.
